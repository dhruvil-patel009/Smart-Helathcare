        ...
        <div className="flex justify-between gap-[50px] lg:gap-[130px] xl:gap-0 flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/2 xl:w-[670px] order-1 lg:order-2">
            ...
            <p className="text__para">
              ...
              Quisquam reprehenderit hic labore aperiam perspiciatis asperiores!
            </p>

            <p className="text__para mt-[30px]">
              Our best is somethings we strive for each day, caring for our
              patients-not looking back at what we accomploshed but towards what
              we can do tomorrow. Providing the best. Lorem ipsum dolor sit amet
              consectetur adipisicing elit. Repellendus, consectetur.
            </p>
